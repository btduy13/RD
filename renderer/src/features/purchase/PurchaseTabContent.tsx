...
import {
  filterPurchaseVouchers,
  getPurchasePaymentLabel,
  type PurchaseFilters,
  type PurchaseTabConfig,
} from "./purchase-service";

export interface PurchaseTabContentProps {
  config: PurchaseTabConfig;
}

export function PurchaseTabContent({ config }: PurchaseTabContentProps) {
  ...
  const vouchers = useMemo(
    () => filterPurchaseVouchers(state, config.voucherType, filters),
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <VoucherListTable
            ...
            vouchers={vouchers}
            canEdit={canEdit}
            paymentLabel={getPurchasePaymentLabel}
