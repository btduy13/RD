@echo off
title Khoi Chay Phan Mem Ke Toan Rang Dong
chcp 65001 > nul
echo ======================================================================
echo          PHAN MEM KE TOAN RANG DONG - RD ACCOUNTING (DESKTOP)
echo ======================================================================
echo.
...
if not exist node_modules (
    echo [THONG BAO] Phat hien day la lan khoi chay dau tien cua ban.
    echo He thong dang tu dong tai va cai dat thu vien Desktop ^(Electron^)...
    echo Vui long giu ket noi Internet. Qua trinh nay co the mat 1-2 phut...
    echo.
    call npm install
    if errorlevel 1 (
        echo.
        echo [LOI CAI DAT] Khong the tai thu vien Electron.
...
echo Dang khoi dong cua so ung dung Ke toan doc lap...
